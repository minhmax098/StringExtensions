...
namespace viettel.StringExtensions
{
    public class TouchManager : MonoBehaviour
    {
        ...
        public void HandleTouchInteraction()
        {
            ...
            if (Input.touchCount < 1 || ObjectManager.Instance.OriginObject == null)
            {
                return;
            }
        ...
        private void Drag(Touch touch, GameObject obj)
        {
            if (obj != null)
            {
                ...
                if (ObjectManager.Instance.FactorScaleInitial > 1)
                    obj.transform.position += (Helper.GetTouchPositionAsWorldPoint(touch) - centerObject) / ObjectManager.Instance.FactorScaleInitial; 
                else
                    obj.transform.position += (Helper.GetTouchPositionAsWorldPoint(touch) - centerObject);
            }
        }
